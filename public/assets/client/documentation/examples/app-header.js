...
export const code = `import { registerElement, html, css} from '/oz.js'
...
export const documentation = `Oz.js expose a
\`javascript
registerElement(options)\`
function used to define custom elements.
Once the element defined, you can create it by calling its constructor(
\`javascript
new myElement()\`
) or by calling
\`javascript
